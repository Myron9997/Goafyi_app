      ...
      <div className="bg-white rounded-2xl p-3 shadow-sm">
        <div className="flex flex-wrap gap-1.5 items-center">
          ...
          <button
            ...
            className="px-2 py-1 rounded-md border border-gray-200 bg-white text-gray-700 hover:border-rose-300 hover:bg-rose-50 transition-all duration-200 focus:outline-none flex items-center gap-1 text-[11px]"
            suppressHydrationWarning={true}
          >
      ...
      {showCategoryList && (
        <Portal>
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-white rounded-2xl w-full max-w-sm sm:max-w-md max-h-[80vh] flex flex-col shadow-xl">
            {/* Header */}
